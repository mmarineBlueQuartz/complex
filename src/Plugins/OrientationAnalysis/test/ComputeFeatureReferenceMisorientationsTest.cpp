...
TEST_CASE("OrientationAnalysis::ComputeFeatureReferenceMisorientationsFilter", "[OrientationAnalysis][ComputeFeatureReferenceMisorientationsFilter]")
{
  ...
  // Instantiate the filter and an Arguments Object
  {
    ...
    args.insertOrAssign(ComputeFeatureReferenceMisorientationsFilter::k_GBEuclideanDistancesArrayPath_Key, std::make_any<DataPath>(DataPath{}));
    ...
    args.insertOrAssign(ComputeFeatureReferenceMisorientationsFilter::k_FeatureReferenceMisorientationsArrayName_Key,
                        std::make_any<DataObjectNameParameter::ValueType>(k_FeatureReferenceMisorientationsArrayName2));
    args.insertOrAssign(ComputeFeatureReferenceMisorientationsFilter::k_FeatureAvgMisorientationsArrayName_Key, std::make_any<DataObjectNameParameter::ValueType>(k_GBEuclideanDistancesArrayName2));
