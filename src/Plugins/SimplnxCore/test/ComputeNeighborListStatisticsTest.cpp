...
TEST_CASE("SimplnxCore::ComputeNeighborListStatisticsFilter: Test Algorithm", "[ComputeNeighborListStatisticsFilter]")
{
  ...
  ComputeNeighborListStatisticsFilter filter;
  Arguments args;

  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindLength_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindMinimum_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindMaximum_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindMean_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindMedian_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindStandardDeviation_Key, std::make_any<bool>(true));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_FindSummation_Key, std::make_any<bool>(true));

  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_InputNeighborListPath_Key, std::make_any<DataPath>(inputArrayPath));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_LengthName_Key, std::make_any<std::string>(length));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_MinimumName_Key, std::make_any<std::string>(minimum));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_MaximumName_Key, std::make_any<std::string>(maximum));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_MeanName_Key, std::make_any<std::string>(mean));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_MedianName_Key, std::make_any<std::string>(median));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_StandardDeviationName_Key, std::make_any<std::string>(stdDev));
  args.insertOrAssign(ComputeNeighborListStatisticsFilter::k_SummationName_Key, std::make_any<std::string>(summation));
